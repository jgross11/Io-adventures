...
LinkedList removeAtIndex := method(index, 
    ...
    */
    ...
    // used to demonstrate a failing submission
    Exception raise("LinkedList removeAtIndex: Not yet implemented!")
)
...
LinkedList indexOf := method(value, 
    ...
    */
    // used to demonstrate a failing submission
    Exception raise("LinkedList indexOf: Not yet implemented!")
)
...
LinkedList get := method(index, 
    ...
    */
    // used to demonstrate a failing submission
    Exception raise("LinkedList get: Not yet implemented!")
)